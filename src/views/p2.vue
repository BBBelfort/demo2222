...
<!--            </el-dialog>-->
<!--            <button @click="handleClick">上传并处理图片</button>-->
        ...
        <el-main>
          <div style="margin-top: 70px">
            <!--          <el-container>-->
            <!--            <el-aside-->
            <!--                style="width: 800px; height: 500px; border: 0px solid #ccc;">-->
            <!--            >-->
            ...
            <!--                </el-image>-->
            <!--              </div>-->
            <!--              <div class="el-upload__text"><em>处理前</em></div>-->
            ...
            <el-col :span="8" v-for="(o, index) in 1" :key="o" :offset="index > 0 ? 2 : 0" style="margin-left: 100px">
              <el-card :body-style="{ padding: '0px' }">
                <el-image
                    style="width: 350px; height: 300px"
                    :src="after_big"
...
export default {
  ...
  methods: {
    ...
    handleClick() {
      axios
          .post("http://127.0.0.1:5000/save-picture3/", this.fileParam)
          .then((response) => {
